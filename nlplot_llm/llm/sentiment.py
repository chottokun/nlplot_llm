        ...
        if not original_text_for_df.strip():
            ...
            if cached_result is not None:
                ...
                try:
                    ...
                    if current_use_cache and nlplot_instance.cache:
                        try:
                            nlplot_instance.cache.set(cache_key_tuple, {"sentiment": sentiment, "raw_llm_output": raw_llm_response_content})
                        except Exception as e:
...
async def _analyze_sentiment_single_async(
    ...
    if not original_text_for_df.strip():
        ...
        cache_key_tuple = (
            "analyze_sentiment_llm", model, prompt_template_str,
        ...
        if cached_result is not None:
            ...
            try:
                ...
                if current_use_cache and nlplot_instance.cache:
                    try: nlplot_instance.cache.set(cache_key_tuple, {"sentiment": sentiment, "raw_llm_output": raw_llm_response_content})
        ...
        if semaphore:
            async with semaphore:
                return await _analyze_sentiment_single_async(
                    nlplot_instance, text_input, model, final_prompt_template_str, temperature, current_use_cache, litellm_kwargs
                )
        else:
            return await _analyze_sentiment_single_async(
                nlplot_instance, text_input, model, final_prompt_template_str, temperature, current_use_cache, litellm_kwargs
