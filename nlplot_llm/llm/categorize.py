    ...
    if not original_text_for_df.strip():
        ...
        if cached_result is not None:
            ...
            try:
                ...
                if current_use_cache and nlplot_instance.cache:
                    try: nlplot_instance.cache.set(cache_key_tuple, {"categories_result": parsed_categories_result, "raw_llm_output": raw_llm_response_content})
...
async def categorize_text_llm_async(
    ...
    **litellm_kwargs
    ...
    current_use_cache = use_cache if use_cache is not None else nlplot_instance.use_cache_default
        ...
        if semaphore:
            async with semaphore:
                return await _categorize_text_single_async(
                    nlplot_instance, text_input, categories, category_list_str_for_prompt, model, final_prompt_template_str,
...
def categorize_text_llm(
    ...
    **litellm_kwargs
    ...
    if "{categories}" in final_prompt_template_str and not category_list_str:
        ...
        if not original_text_for_df.strip():
            ...
            if cached_result is not None:
                ...
                try:
                    ...
                    if current_use_cache_for_call and nlplot_instance.cache:
                        try:
                            nlplot_instance.cache.set(cache_key_tuple, {"categories_result": parsed_categories, "raw_llm_output": raw_llm_response_content})
                        except Exception as e:
